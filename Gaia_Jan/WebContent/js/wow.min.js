	...
	l.notSupported=!0,m),q=window.getComputedStyle||function(a){
		...
		return n(a,[{
			key:"init",value:function(){
				...
				d(document.readyState,["interactive","complete"])?this.start():i(document,"DOMContentLoaded",this.start),this.finished=[]
			}
		},{
			key:"start",
			value:function(){
			...
			key:"vendorCSS",
			value:function(a,b){
				for(var c=q(a),d=c.getPropertyCSSValue(b),
			...
			value:function(a){
				...
				d=c+Math.min(this.element.clientHeight,
				k())-b,
				e=this.offsetTop(a),
				f=e+a.clientHeight;
				return d>=e&&f>=c
