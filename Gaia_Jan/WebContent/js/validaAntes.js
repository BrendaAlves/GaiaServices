				// >>>> FUNÇÃO PARA EXIBIR MODAL AO ABRIR A TELA
$(document).ready(function() {
	var carrega = localStorage.getItem('news_email');
	if ((carrega == "") || (carrega == null)) {
		$('#modal_BemVindo').modal('show');
	}
	localStorage.setItem('news_email',1);
});

				// >>>> AUTO COMPLETE DO CEP
/*$("#busca_cep").focusout(function(){
