...
<html>
	...
	<body>
		...
		<%
			...
			String cad_cnpj = request.getParameter("cad_cnpj");
			...
			//Salva no local
			String arquivo = "C:\\Users\\brenda.lopes\\eclipse-workspace\\Gaia\\" +cad_cnpj+ ".txt";
			...
			if (!file.exists()) {  
				//Salvar dados formato txt
	   			...
	   			mensagem = "<script> document.getElementById('modalLabel').innerHTML = '" +cad_nome+ " seu cadastrado foi realizado com sucesso!'</script>";
